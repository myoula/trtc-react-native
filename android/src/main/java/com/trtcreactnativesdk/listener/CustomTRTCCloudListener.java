...
public class CustomTRTCCloudListener extends TRTCCloudListener {
     ...
     */
    @Override
    public void onUserVideoSizeChanged(String userId, int i, int i1, int i2) {
        super.onUserVideoSizeChanged(userId, i, i1, i2);
        Map<String, Object> params = new HashMap<>(4, 1);
        params.put("userId", userId);
        params.put("streamType", i);
        params.put("newWidth", i1);
        params.put("newHeight", i2);
        this.invokeListener(CallBackNoticeEnum.onUserVideoSizeChanged, params);
    }
