...
const {
  TrtcReactNativeSdk
} = _reactNative.NativeModules; /// 设备管理
...
class TXDeviceManager {
  ...
  */
  ...
  switchCamera(isFrontCamera) {
    return TrtcReactNativeSdk.switchCamera({
      isFrontCamera
    });
  }
  /**
...
exports.default = TXDeviceManager;
//# sourceMappingURL=tx_device_manager.js.map