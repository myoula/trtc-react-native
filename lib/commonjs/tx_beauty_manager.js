...
const {
  TrtcReactNativeSdk
} = _reactNative.NativeModules; /// 美颜及动效参数管理
...
class TXBeautyManager {
  ...
  */
  ...
  setBeautyStyle(beautyStyle) {
    return TrtcReactNativeSdk.setBeautyStyle({
      beautyStyle
    });
  }
  /**
  ...
  */
  ...
  setFilter(image) {
    return TrtcReactNativeSdk.setFilter({
      imageUrl: image
    });
  }
  /**
...
exports.default = TXBeautyManager;
//# sourceMappingURL=tx_beauty_manager.js.map