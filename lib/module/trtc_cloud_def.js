...
})(TXVoiceChangerType || (TXVoiceChangerType = {}));

export let TXVoiceReverbType;
...
})(TXVoiceReverbType || (TXVoiceReverbType = {}));

export let TXSystemVolumeType;
/**
- 音乐和人声设置接口参数
*/
