...
- 关键类型定义变量
*/
export declare class TRTCCloudDef {
    static TRTC_SDK_VERSION: String;
    /**
    - 此处仅定义横屏分辨率，如需使用竖屏分辨率（例如360 × 640），需要同时指定 TRTCVideoResolutionMode 为 Portrait。
    - 建议码率 VideoCall:80kbps   LIVE:120kbps
    */
    static TRTC_VIDEO_RESOLUTION_120_120: number;
    /**
    - 建议码率 VideoCall:100kbps  LIVE:150kbps
    */
    static TRTC_VIDEO_RESOLUTION_160_160: number;
    /**
    - 建议码率 VideoCall:200kbps  LIVE:120kbps
    */
    static TRTC_VIDEO_RESOLUTION_270_270: number;
    /**
    - 建议码率 VideoCall:350kbps  LIVE:120kbps
    */
    static TRTC_VIDEO_RESOLUTION_480_480: number;
    /**
    - 建议码率 VideoCall:100kbps  LIVE:150kbps
    */
    static TRTC_VIDEO_RESOLUTION_160_120: number;
    /**
    - 建议码率 VideoCall:150kbps  LIVE:225kbps
    */
    static TRTC_VIDEO_RESOLUTION_240_180: number;
    /**
    - 建议码率 VideoCall:200kbps  LIVE:300kbps
    */
    static TRTC_VIDEO_RESOLUTION_280_210: number;
    /**
    - 建议码率 VideoCall:250kbps  LIVE:375kbps
    */
    static TRTC_VIDEO_RESOLUTION_320_240: number;
    /**
    - 建议码率 VideoCall:300kbps  LIVE:450kbps
    */
    static TRTC_VIDEO_RESOLUTION_400_300: number;
    /**
    - 建议码率 VideoCall:400kbps  LIVE:600kbps
    */
    static TRTC_VIDEO_RESOLUTION_480_360: number;
    /**
    - 建议码率 VideoCall:600kbps  LIVE:900kbps
    */
    static TRTC_VIDEO_RESOLUTION_640_480: number;
    /**
    - 建议码率 VideoCall:1000kbps LIVE:1500kbps
    */
    static TRTC_VIDEO_RESOLUTION_960_720: number;
    /**
    - 建议码率 VideoCall:150kbps  LIVE:250kbps
    */
    static TRTC_VIDEO_RESOLUTION_160_90: number;
    /**
    - 建议码率 VideoCall:200kbps  LIVE:300kbps
    */
    static TRTC_VIDEO_RESOLUTION_256_144: number;
    /**
    - 建议码率 VideoCall:250kbps  LIVE:400kbps
    */
    static TRTC_VIDEO_RESOLUTION_320_180: number;
    /**
    - 建议码率 VideoCall:350kbps  LIVE:550kbps
    */
    static TRTC_VIDEO_RESOLUTION_480_270: number;
    /**
    - 建议码率 VideoCall:550kbps  LIVE:900kbps
    */
    static TRTC_VIDEO_RESOLUTION_640_360: number;
    /**
    - 建议码率 VideoCall:850kbps  LIVE:1300kbps
    */
    static TRTC_VIDEO_RESOLUTION_960_540: number;
    /**
    - 建议码率 VideoCall:1200kbps LIVE:1800kbps
    */
    static TRTC_VIDEO_RESOLUTION_1280_720: number;
    /**
    - 建议码率 VideoCall:2000kbps LIVE:3000kbps
    */
    static TRTC_VIDEO_RESOLUTION_1920_1080: number;
    /**
     *  @name 1.2 视频宽高比模式
     *
    ...
    - 横屏分辨率
    */
    static TRTC_VIDEO_RESOLUTION_MODE_LANDSCAPE: number;
    /**
    - 竖屏分辨率
    */
    static TRTC_VIDEO_RESOLUTION_MODE_PORTRAIT: number;
    /**
     * @name 1.3 视频流类型
     *
    ...
    - 主画面视频流
    */
    static TRTC_VIDEO_STREAM_TYPE_BIG: number;
    /**
    - 小画面视频流
    */
    static TRTC_VIDEO_STREAM_TYPE_SMALL: number;
    /**
    - 辅流（屏幕分享）
    */
    static TRTC_VIDEO_STREAM_TYPE_SUB: number;
    /**
    ...
    - 未定义
    */
    static TRTC_QUALITY_UNKNOWN: number;
    /**
    - 最好
    */
    static TRTC_QUALITY_Excellent: number;
    /**
    - 好
    */
    static TRTC_QUALITY_Good: number;
    /**
    - 一般
    */
    static TRTC_QUALITY_Poor: number;
    /**
    - 差
    */
    static TRTC_QUALITY_Bad: number;
    /**
    - 很差
    */
    static TRTC_QUALITY_Vbad: number;
    /**
    - 不可用
    */
    static TRTC_QUALITY_Down: number;
    /**
     * @name 1.5 视频画面填充模式
    ...
    */
    static TRTC_VIDEO_RENDER_MODE_FILL: number;
    /**
    - 图像长边填满屏幕，短边区域会被填充黑色
    */
    static TRTC_VIDEO_RENDER_MODE_FIT: number;
    /**
     * @name 1.6 视频画面旋转方向
    ...
    - 不旋转
    */
    static TRTC_VIDEO_ROTATION_0: number;
    /**
    - 顺时针旋转90度
    */
    static TRTC_VIDEO_ROTATION_90: number;
    /**
    - 顺时针旋转180度
    */
    static TRTC_VIDEO_ROTATION_180: number;
    /**
    - 顺时针旋转270度
    */
    static TRTC_VIDEO_ROTATION_270: number;
    /**
     * @name 1.7 美颜（磨皮）算法
     *
    ...
    - 光滑，适用于美女秀场，效果比较明显。
    */
    static TRTC_BEAUTY_STYLE_SMOOTH: number;
    /**
    - 自然，磨皮算法更多地保留了面部细节，主观感受上会更加自然。
    */
    static TRTC_BEAUTY_STYLE_NATURE: number;
    /**
    - P图，磨皮相比光滑更加自然，相比光滑保留更多的皮肤细节。
    */
    static TRTC_BEAUTY_STYLE_PITU: number;
    /**
     * @name 1.8 视频像素格式
     *
    ...
    - 未知
    */
    static TRTC_VIDEO_PIXEL_FORMAT_UNKNOWN: number;
    /**
    - YUV I420
    */
    static TRTC_VIDEO_PIXEL_FORMAT_I420: number;
    /**
    - OpenGL 2D 纹理
    */
    static TRTC_VIDEO_PIXEL_FORMAT_Texture_2D: number;
    static TRTC_VIDEO_PIXEL_FORMAT_TEXTURE_EXTERNAL_OES: number;
    static TRTC_VIDEO_PIXEL_FORMAT_NV21: number;
    /**
    ...
    */
    static TRTC_VIDEO_MIRROR_TYPE_AUTO: number;
    /**
    - 前置摄像头和后置摄像头都镜像
    */
    static TRTC_VIDEO_MIRROR_TYPE_ENABLE: number;
    /**
    - 前置摄像头和后置摄像头都不镜像
    */
    static TRTC_VIDEO_MIRROR_TYPE_DISABLE: number;
    /**
     * @name 2.1 应用场景
    ...
    */
    static TRTC_APP_SCENE_VIDEOCALL: number;
    /**
    ...
    */
    ...
    - 注意：此场景下，您必须通过 TRTCParams 中的 role 字段指定当前用户的角色。
    */
    static TRTC_APP_SCENE_VOICE_CHATROOM: number;
    /**
    - 主播
    */
    static TRTCRoleAnchor: number;
    /**
    - 观众
    */
    static TRTCRoleAudience: number;
    /**
    - 客户端控制（用于 SDK 开发内部调试，客户请勿使用）
    */
    static VIDEO_QOS_CONTROL_CLIENT: number;
    /**
    - 云端控制 （默认）
    */
    static VIDEO_QOS_CONTROL_SERVER: number;
    /**
     @name 2.4 画质偏好
     ...
     - 弱网下保流畅
    */
    static TRTC_VIDEO_QOS_PREFERENCE_SMOOTH: number;
    /**
    - 弱网下保清晰，默认值
    */
    static TRTC_VIDEO_QOS_PREFERENCE_CLEAR: number;
    /**
    - @name 3.1 音频采样率
    - 音频采样率用来衡量声音的保真程度，采样率越高保真程度越好，如果您的应用场景有音乐的存在，推荐使用 TRTCAudioSampleRate48000。
    - 16k采样率
    */
    static TRTCAudioSampleRate16000: number;
    /**
    - 32采样率
    */
    static TRTCAudioSampleRate32000: number;
    /**
    - 44.1k采样率
    */
    static TRTCAudioSampleRate44100: number;
    /**
    - 48k采样率
    */
    static TRTCAudioSampleRate48000: number;
    /**
     * @name 3.2 声音音质
     *
     * 音频音质用来衡量声音的保真程度。
    ...
    */
    static TRTC_AUDIO_QUALITY_SPEECH: number;
    /**
    - 默认音质：采样率：48k；单声道；音频裸码率：50kbps；SDK 默认的音频质量，如无特殊需求推荐选择之。
    */
    static TRTC_AUDIO_QUALITY_DEFAULT: number;
    /**
    - 高音质：采样率：48k；双声道 + 全频带；音频裸码率：128kbps；适合需要高保真传输音乐的场景，比如K歌、音乐直播等。
    */
    static TRTC_AUDIO_QUALITY_MUSIC: number;
    /**
    - 扬声器
    */
    static TRTC_AUDIO_ROUTE_SPEAKER: number;
    /**
    - 听筒
    */
    static TRTC_AUDIO_ROUTE_EARPIECE: number;
    /**
    - 关闭混响
    */
    static TRTC_REVERB_TYPE_0: number;
    /**
    - KTV
    */
    static TRTC_REVERB_TYPE_1: number;
    /**
    - 小房间
    */
    static TRTC_REVERB_TYPE_2: number;
    /**
    - 大会堂
    */
    static TRTC_REVERB_TYPE_3: number;
    /**
    - 低沉
    */
    static TRTC_REVERB_TYPE_4: number;
    /**
    - 洪亮
    */
    static TRTC_REVERB_TYPE_5: number;
    /**
    - 金属声
    */
    static TRTC_REVERB_TYPE_6: number;
    /**
    - 磁性
    */
    static TRTC_REVERB_TYPE_7: number;
    /**
    - 关闭变声
    */
    static TRTC_VOICE_CHANGER_TYPE_0: number;
    /**
    - 熊孩子
    */
    static TRTC_VOICE_CHANGER_TYPE_1: number;
    /**
    - 萝莉
    */
    static TRTC_VOICE_CHANGER_TYPE_2: number;
    /**
    - 大叔
    */
    static TRTC_VOICE_CHANGER_TYPE_3: number;
    /**
    - 重金属
    */
    static TRTC_VOICE_CHANGER_TYPE_4: number;
    /**
    - 感冒
    */
    static TRTC_VOICE_CHANGER_TYPE_5: number;
    /**
    - 外国人
    */
    static TRTC_VOICE_CHANGER_TYPE_6: number;
    /**
    - 困兽
    */
    static TRTC_VOICE_CHANGER_TYPE_7: number;
    /**
    - 死肥仔
    */
    static TRTC_VOICE_CHANGER_TYPE_8: number;
    /**
    - 强电流
    */
    static TRTC_VOICE_CHANGER_TYPE_9: number;
    /**
    - 重机械
    */
    static TRTC_VOICE_CHANGER_TYPE_10: number;
    /**
    - 空灵
    */
    static TRTC_VOICE_CHANGER_TYPE_11: number;
    /**
    - PCM
    */
    static TRTC_AUDIO_FRAME_FORMAT_PCM: number;
    /**
    ...
    */
    static TRTCSystemVolumeTypeAuto: number;
    /**
    - 通话全程使用媒体音量，不常用，适合个别有特殊需求（如主播外接声卡）的应用场景。
    */
    static TRTCSystemVolumeTypeMedia: number;
    /**
    - 全程使用通话音量，适合多人会议场景。
  
    - 如果您在 enterRoom 时选择的场景为 TRTC_APP_SCENE_VIDEOCALL 或 TRTC_APP_SCENE_AUDIOCALL，SDK 会自动选择该模式。
    */
    static TRTCSystemVolumeTypeVOIP: number;
    /**
    - 界面不显示 Log
    */
    static TRTC_DEBUG_VIEW_LEVEL_GONE: number;
    /**
    - 界面上半部分显示状态 Log
    */
    static TRTC_DEBUG_VIEW_LEVEL_STATUS: number;
    /**
    - 界面上半部分显示状态 Log，下半部分显示关键事件
    */
    static TRTC_DEBUG_VIEW_LEVEL_ALL: number;
    /**
     * - 输出所有级别的 Log
     */
    static TRTC_LOG_LEVEL_VERBOSE: number;
    /**
     * - 输出 DEBUG，INFO，WARNING，ERROR 和 FATAL 级别的 Log
     */
    static TRTC_LOG_LEVEL_DEBUG: number;
    /**
     * - 输出 INFO，WARNING，ERROR 和 FATAL 级别的 Log
     */
    static TRTC_LOG_LEVEL_INFO: number;
    /**
     * - 输出 WARNING，ERROR 和 FATAL 级别的 Log
     */
    static TRTC_LOG_LEVEL_WARN: number;
    /**
     * - 只输出 ERROR 和 FATAL 级别的 Log
     */
    static TRTC_LOG_LEVEL_ERROR: number;
    /**
     * - 只输出 FATAL 级别的 Log
     */
    static TRTC_LOG_LEVEL_FATAL: number;
    /**
    - 不输出任何 SDK Log
    */
    static TRTC_LOG_LEVEL_NULL: number;
    /**
     * @name 4.3 重力感应开关
     *
    ...
    - 关闭重力感应。
    */
    static TRTC_GSENSOR_MODE_DISABLE: number;
    /**
    - 开启重力感应，默认值。
    */
    static TRTC_GSENSOR_MODE_UIAUTOLAYOUT: number;
    /**
    - 待废弃，效果等同于 UIAutoLayout。
    */
    static TRTC_GSENSOR_MODE_UIFIXLAYOUT: number;
    /**
     * @name 4.4 混流参数配置模式
     *
     */
    ...
    - 非法值
    */
    static TRTC_TranscodingConfigMode_Unknown: number;
    /**
    ...
    */
    static TRTC_TranscodingConfigMode_Manual: number;
    /**
    ...
    */
    static TRTC_TranscodingConfigMode_Template_PureAudio: number;
    /**
    ...
    */
    static TRTC_TranscodingConfigMode_Template_PresetLayout: number;
    /**
    ...
    */
    static TRTC_TranscodingConfigMode_Template_ScreenSharing: number;
    /**
    - 安卓视频渲染使用TextureView
    */
    static TRTC_VideoView_TextureView: number;
    /**
    - 安卓视频渲染使用SurfaceView
    */
    static TRTC_VideoView_SurfaceView: number;
}
/**
 - 切换房间参数
*/
export declare type TRTCSwitchRoomConfig = {
    /**
    - 【字段含义】用户签名 [必填]，当前 userId 对应的验证签名，相当于使用云服务的登录密码。
    -
    - 【推荐取值】具体计算方法请参见 [如何计算UserSig](https://cloud.tencent.com/document/product/647/17275)。
...
*/
export declare type TRTCVideoEncParam = {
    /**
    -【字段含义】 视频分辨率
    -
    -【推荐取值】
...
*/
export declare type TRTCNetworkQosParam = {
    /**
...
- 远端图像参数
*/
export declare type TRTCRenderParams = {
    /**
    -【字段含义】图像顺时针旋转角度
    -
    -【特别说明】
...
*/
export declare type TRTCMixUser = {
    /**
    - 参与混流的 userId
    */
    userId: string;
...
- 包括最终编码质量和各路画面的摆放位置
*/
export declare type TRTCTranscodingConfig = {
    /**
    -【字段含义】腾讯云直播 AppID
...
*/
export declare enum TXVoiceChangerType {
    /**
    - 关闭变声
    */
...
*/
export declare enum TXVoiceReverbType {
    /**
    - 关闭混响
    */
...
export declare enum TXSystemVolumeType {
    /**
...
- 音乐和人声设置接口参数
*/
export declare type AudioMusicParam = {
    /**
    - 【字段含义】音乐 ID
...
*/
export declare type TRTCAudioRecordingParams = {
    filePath: string;
};
/**
- CDN 转推参数
*/
export declare type TRTCPublishCDNParam = {
    /**
